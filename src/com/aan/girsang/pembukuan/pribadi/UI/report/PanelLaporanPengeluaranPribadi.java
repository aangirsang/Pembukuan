...
public class PanelLaporanPengeluaranPribadi extends javax.swing.JPanel {
...
//</editor-fold>
    public PanelLaporanPengeluaranPribadi() {
        initComponents();
        initListener();
        isiCombo();
    }
    ...
    private void tampilReport(){
        JasperPrint print = Pembukuan.getReportPribadiService()
                .reportRekapPengeluaranPribadi(cboBulan.getSelectedIndex(), (int) jspTahun.getValue());
