...
public class PanelLaporanPemasukanPribadi extends javax.swing.JPanel {
...
//</editor-fold>
    public PanelLaporanPemasukanPribadi() {
        initComponents();
        initListener();
        isiCombo();
    }
    ...
    private void tampilReport(){
        JasperPrint print = Pembukuan.getReportPribadiService()
                .reportRekapPemasukanPribadi(cboBulan.getSelectedIndex(), (int) jspTahun.getValue());
