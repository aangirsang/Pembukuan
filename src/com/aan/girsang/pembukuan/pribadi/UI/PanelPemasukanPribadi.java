...
public class PanelPemasukanPribadi extends javax.swing.JPanel {

    PemasukanPribadi pribadi;
...
//</editor-fold>
    ...
    private void tampilData(){
        daftarPemasukan = Pembukuan.getPribadiService().semuaPemasukanPribadi();
        tabel.setModel(new TabelModelPemasukanPribadi(daftarPemasukan));
    ...
    private void cariData(){
        if(idSelect.equals("")){
            ...
            pribadi = Pembukuan.getPribadiService().cariidPemasukan(idSelect);
        }
    }
    private void tambahData(){
        pribadi = null;
        PemasukanPribadi p = new DialogPemasukanPribadi().showDialog(pribadi);
        if(p!=null){
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Gambar/user-arrow-down-icon-64.png"))); // NOI18N

        jLabel2.setFont(new java.awt.Font("Comic Sans MS", 1, 18)); // NOI18N
        jLabel2.setText("Daftar Pemasukan Pribadi");

        jLabel3.setFont(new java.awt.Font("Comic Sans MS", 1, 11)); // NOI18N
        jLabel3.setText("Disini anda bisa menambah, mengedit atau menghapus data pemsaukan pribadi");
