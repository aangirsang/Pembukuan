...
public class DialogPengeluaranPribadi extends javax.swing.JDialog {

    private PengeluaranPribadi pribadi;
    public DialogPengeluaranPribadi() {
    ...
    public PengeluaranPribadi showDialog(PengeluaranPribadi p){
        clear();
        if(p==null){
            pribadi = new PengeluaranPribadi();
            setTitle("Tambah Pengeluaran Pribadi");
        }else{
            setTitle("Ubah Pengeluaran Pribadi");
            pribadi = p;
            tampilData(pribadi);
        }
    ...
    private void tampilData(PengeluaranPribadi p){
