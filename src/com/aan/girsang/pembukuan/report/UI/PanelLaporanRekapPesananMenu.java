...
public class PanelLaporanRekapPesananMenu extends javax.swing.JPanel {
...
//</editor-fold>
    public PanelLaporanRekapPesananMenu() {
        initComponents();
        initListener();
        isiCombo();
    }
    ...
    private void tampilReport(){
        JasperPrint print = Pembukuan.getKeuanganReportService().reportRekapPesananMenu(cboBulan.getSelectedIndex(), (int) jspTahun.getValue());
