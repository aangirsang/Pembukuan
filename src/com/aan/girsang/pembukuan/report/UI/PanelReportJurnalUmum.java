...
public class PanelReportJurnalUmum extends javax.swing.JPanel {
...
//</editor-fold>
    public PanelReportJurnalUmum() {
        initComponents();
        initListener();
        clear();
    }
    private void tampilSemuaReport(){
        JasperPrint print = Pembukuan.getKeuanganReportService().reportJurnalUmum();
    ...
    private void tampilfilter(){
        JasperPrint print = Pembukuan.getKeuanganReportService()
                .reportJurnalUmum(jdcMulai.getDate(), jdcAkhir.getDate());
        JRViewer viewer = new JRViewer(print);
        Locale local = new Locale("id","ID");
        viewer.setLocale(local);
        viewer.setPreferredSize(getPreferredSize());
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        .addComponent(btnTampil, javax.swing.GroupLayout.Alignment.CENTER)
